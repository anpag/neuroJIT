...
"$BUILD_DIR/tools/tensorlang-run/tensorlang-run" \
    --runner=llama \
    --model="$PROJECT_ROOT/tensorlang/runtime/models/qwen2.5-coder-7b-instruct-q4_k_m.gguf" \
    "$PROJECT_ROOT/tensorlang/examples/neuro_lander.mlir"
